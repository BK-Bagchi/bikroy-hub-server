...
export const payThroughSsl = async (req, res) => {
  ...
  const data = {
    ...
    currency: "BDT",
    tran_id: orderId,
    success_url: `${process.env.BASE_URL}/sslcomerz/payment/success/${orderId}/${req.body.customerEmail}`,
    fail_url: `${process.env.BASE_URL}/sslcomerz/payment/fail/${orderId}/${req.body.customerEmail}`,
